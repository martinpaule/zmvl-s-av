...
Kapela hrala prevažne na moravskej hardcore scéne v rokoch 1994-1996 so spriaznenou kapelou Zabloudil. Posledné vystúpenie bolo v septembri 1998 v Trenčíne.`,
  ...
  en: {
    name: "ZOŽER MESIAC V LUFTE",
    shortName: "ZMVL",
    origin: "Prievidza, Slovakia",
    yearsActive: "1991–1998",
    genre: "Industrial / Noise / Experimental",
    tagline: "Industrial noise from the underground scene.",
    bio: `ZOŽER MESIAC V LUFTE (meaning "Eat Moon in the Air") was an industrial/noise project from Prievidza, Slovakia, founded in 1991 after witnessing Einstürzende Neubauten live in Vienna. Their original concept of "naive industrial metal-on-metal" meant frenzied strikes on metal objects – sheets, barrels, springs, and anvils – combined with a destroyed bass played with screwdrivers and files.
...
export type BandInfo = typeof bandInfo.sk;
